...
:ogcapi-common-1: <<OGCAPI-Common-1, OGC API - Common - Part 1>>
:ogcapi-common-2: <<OGCAPI-Common-2, OGC API - Common - Part 2>>
:ogcapi-features: <<OGCAPI-Features-1, OGC API - Features>>
:ogcapi-features-1: <<OGCAPI-Features-1, OGC API - Features - Part 1>>
:ogcapi-features-2: <<OGCAPI-Features-2, OGC API - Features - Part 2>>
:ogcapi-features-4: <<OGCAPI-Features-4, OGC API - Features - Part 4>>
:ogc-w3c-ssn: <<SOSA-SSN, Semantic Sensor Network Ontology (SOSA/SSN)>>
//
//:jsonschema-root: https://raw.githubusercontent.com/opengeospatial/connected-systems/master/api/part1/openapi/schemas
...
//
:ogcapi-features-spec-url: http://www.opengis.net/spec/ogcapi-features-1/1.0
...
include::sections/clause_9_requirements_class_system_components.adoc[]
...
include::sections/clause_13_requirements_class_property_definitions.adoc[]
