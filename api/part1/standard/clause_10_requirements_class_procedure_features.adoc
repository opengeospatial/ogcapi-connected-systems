...
| Observing           | http://www.opengis.net/def/x-OGC/ObservingProcedure   | Sensor   | To describe a 'sensing' process
| Actuating           | http://www.opengis.net/def/x-OGC/ActuatingProcedure   | Actuator | To describe an 'actuating' process
| Sampling            | http://www.opengis.net/def/x-OGC/SamplingProcedure    | Sampler  | To describe a 'sampling' process
| Simulation          | http://www.opengis.net/def/x-OGC/SimulationProcedure  | Sensor or System   | To describe a model or simulation
| Moving              | http://www.opengis.net/def/x-OGC/MobilityProcedure    | Platform | To describe a motion pattern
|====
