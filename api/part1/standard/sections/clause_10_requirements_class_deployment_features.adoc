...
| `deployedSystems`     | `ssn:deployedOnPlatform` | The list of `Systems` deployed during the `Deployment`, if any. | A collection of `System` resources (inline or by-reference). | Required
