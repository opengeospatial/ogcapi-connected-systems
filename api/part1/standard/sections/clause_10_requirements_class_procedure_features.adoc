...
The following table lists `Procedure` resource attributes and their mapping to SOSA/SSN.
...
The following table lists `Procedure` resource assocations and their mapping to SOSA/SSN.
