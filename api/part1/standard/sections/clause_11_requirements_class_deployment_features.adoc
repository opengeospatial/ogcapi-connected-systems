...
| `featuresOfInterest`  | The ultimate features of interest that are observed and/or controlled during the deployment. | A collection of `Feature` resources | Optional
...
| `controlStreams`      | The control streams containing commands issued during the deployment. | A collection of `ControlStream` resources | Optional
|====
