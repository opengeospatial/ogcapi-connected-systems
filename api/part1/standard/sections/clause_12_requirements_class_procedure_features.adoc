...
| Observing         | http://www.w3.org/ns/sosa/oms/ObservingProcedure   | sosa-oms:ObservingProcedure   | Sensor     | An observation method.
| Sampling          | http://www.w3.org/ns/sosa/oms/SamplingProcedure    | sosa-oms:SamplingProcedure    | Sampler    | A sampling method.
| Preparation       | http://www.w3.org/ns/sosa/oms/PreparationProcedure | sosa-oms:PreparationProcedure | Any System | A preparation method.
// | Actuating         | http://www.w3.org/ns/sosa/oms/ActuatingProcedure   | sosa-oms:ActuatingProcedure   | Actuator   | An actuation method.
