...
| Sensor Kind       | http://www.w3.org/ns/ssn-system/SensorKind    | ssn:SensorKind | Sensor   | A sensor datasheet.
| Actuator Kind     | http://www.w3.org/ns/ssn-system/ActuatorKind  | ssn:ActuatorKind | Actuator | An actuator datasheet.
| Sampler Kind      | http://www.w3.org/ns/ssn-system/SamplerKind   | ssn:SamplerKind  | Sampler  | A sampler datasheet.
| Platform Kind     | http://www.w3.org/ns/ssn-system/PlatformKind  | ssn:PlatformKind | Platform  | A platform datasheet.
| Other System Kind | http://www.w3.org/ns/ssn-system/SystemKind    | ssn:SystemKind | Any System | Any other system datasheet.
|====
