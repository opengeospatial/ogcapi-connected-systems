...
This standard requires that a `Sampling Feature` resource has a canonical URL through which it can be retrieved independently of its membership to any collection.
...
include::../requirements/sampling/common/req_canonical_collection.adoc[]
