...
include::../requirements/sampling/req_resource.adoc[]
...
include::../requirements/sampling/req_canonical_url.adoc[]


=== Root Collection

include::../requirements/sampling/req_canonical_collection.adoc[]
...
include::../requirements/sampling/req_collections_type.adoc[]

A default collection containing all sampling features must be available at the API endpoint.

include::../requirements/sampling/req_collections_catchall.adoc[]
...
include::../requirements/sampling/req_collections_others.adoc[]
