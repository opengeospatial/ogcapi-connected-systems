...
| `systemKind`        | `properties/systemKind@link`    | Value is a weblink resolving to a `System` resource.
...
| `procedures`        | `links`                         | Value is a weblink* resolving to a `Procedure` collection.
3+| {weblinks-footnote} 
|====
