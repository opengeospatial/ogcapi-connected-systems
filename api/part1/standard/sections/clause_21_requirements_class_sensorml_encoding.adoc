...
====
[%metadata]
identifier:: /req/sensorml/procedure-attribute-mapping
...
====
[%metadata]
identifier:: /req/sensorml/deployment-attribute-mapping
...
====
[%metadata]
identifier:: /req/sensorml/property-attribute-mapping
