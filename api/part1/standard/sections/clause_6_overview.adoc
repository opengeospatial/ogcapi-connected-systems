...
| `ogc-rel:relatedSamplingFeatures`  | <<sf-assocs,`Sampling Feature`>>            | Link to other sampling features that are either parent sample or subsamples of the sampling feature.
