...
For consistency, it is recommended that the server includes these changing components in the sub-collection, in accordance with the time provided by the `datetime` query parameter.
