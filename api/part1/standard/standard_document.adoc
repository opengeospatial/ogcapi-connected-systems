:Title: OGC API - Connected Systems - Part 1
:titletext: OGC API - Connected Systems - Part 1: Feature Resources
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
//pygments
:doc-type: IS
:standard: ogcapi-connectedsystems-1
:version: 0.1.0.draft
...
|Internal reference number of this OGC(R) document:    23-001
|Version: {version}
...
include::clause_9_requirements_class_system_features.adoc[]

include::clause_10_requirements_class_procedure_features.adoc[]

include::clause_11_requirements_class_deployment_features.adoc[]

include::clause_12_requirements_class_sampling_features.adoc[]

include::clause_13_requirements_class_system_components.adoc[]

include::clause_14_requirements_class_advanced_filtering.adoc[]

include::clause_15_requirements_class_feature_cud.adoc[]

// encodings

include::clause_20_requirements_class_geojson_encoding.adoc[]

include::clause_21_requirements_class_sensorml_encoding.adoc[]

include::clause_22_requirements_class_jsonfg_encoding.adoc[]
