...
| `validTime`          | The validity period of the datastream's description. | TimePeriod | Optional
| `phenomenonTime`     | The time period spanned by the phenomenon times of all observations in this datastream. | TimePeriod | Mandatory
| `resultTime`         | The time period spanned by the result times of all observations in this datastream. | TimePeriod | Mandatory
...
In addition to top-level collections, each system exposes its own datastreams as a sub-collection.
...
|====
| *Name*              | *Definition* | *Data Type* | *Usage*
| `phenomenonTime`    | The time the command was received by the system. | DateTime | Mandatory
| `resultTime`        | The time period during which the command was executed. The time period ends when the effect of the command has modified all controlled properties of the feature of interest. | TimePeriod | Mandatory
| `parameters`        | Observation parameters. | Any | Optional
| `result`            | Observation result. | Any | Mandatory
|====
