...
include::../requirements/controlstream/feasibility/req_canonical_url.adoc[]
...
====
[%metadata]
identifier:: /req/controlstream/feasibility-ref-from-controlstream
...
====
[%metadata]
identifier:: /req/controlstream/feasibility-status-endpoint
...
====
[%metadata]
identifier:: /req/controlstream/feasibility-result-endpoint
