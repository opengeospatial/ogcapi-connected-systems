...
include::clause_10_requirements_class_system_events.adoc[]

include::clause_11_requirements_class_system_history.adoc[]

include::clause_12_requirements_class_resource_events.adoc[]
