:Title: OGC API - Connected Systems - Part 2
:titletext: OGC API - Connected Systems - Part 2: Dynamic Data
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
//pygments
:doc-type: IS
:standard: ogcapi-connectedsystems-2
:version: 0.1.0.draft
...
:ogcapi-consys-1: ../../standard_document.html[OGC API - Connected Systems - Part 1]
...
|Internal reference number of this OGC(R) document:    23-002
|Version: {version}
...
include::clause_7_requirements_class_common.adoc[]

include::clause_8_requirements_class_datastreams.adoc[]

include::clause_9_requirements_class_controls.adoc[]

include::clause_10_requirements_class_resource_events.adoc[]

include::clause_11_requirements_class_system_events.adoc[]

include::clause_12_requirements_class_system_history.adoc[]

// filtering

include::clause_13_requirements_class_advanced_filtering.adoc[]

// create/replace/update/delete

include::clause_14_requirements_class_resource_crud.adoc[]


== Requirements Classes for Encodings

include::clause_20_requirements_class_json_encoding.adoc[]

include::clause_21_requirements_class_swecommon_json_encoding.adoc[]

include::clause_22_requirements_class_swecommon_text_encoding.adoc[]

include::clause_23_requirements_class_swecommon_binary_encoding.adoc[]

//include::clause_24_requirements_class_swecommon_protobuf_encoding.adoc[]


== Requirements Classes for Transport Protocols

include::clause_30_requirements_class_websocket.adoc[]

include::clause_31_requirements_class_mqtt.adoc[]
