...
Resource Events may be provided without an associated CS API HTTP service, using the resource identifiers specified by the Resource Events requirements class. This does not waive the requirements of Parts 1 or 2 for implementations claiming conformance to their HTTP requirements classes.
