...
The `SimpleProcess.json` schema is the JSON schema implementation of the `SimpleProcess` UML class defined in https://docs.ogc.org/is/12-000r2/12-000r2.html#43[clause 7.3.1] of <<OGC-SML>>.
