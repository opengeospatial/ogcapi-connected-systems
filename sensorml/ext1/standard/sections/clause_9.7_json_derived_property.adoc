...
The `DerivedProperty.json` schema is the JSON schema implementation of the `DerivedProperty` UML class defined in <<clause_model_derived_property,style=full%>>.
