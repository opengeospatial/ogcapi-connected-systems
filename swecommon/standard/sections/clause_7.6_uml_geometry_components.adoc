...
- GML in the <<xml_impl,XML implementation>> and <<encoding_rules_xml,XML encoding rules>>
- GeoJSON in the <<json_impl,JSON implementation>> and <<encoding_rules_json,JSON encoding rules>>
