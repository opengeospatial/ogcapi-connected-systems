...
The “UnitReference” object is the JSON schema representation of the “UnitOfMeasure” UML classes used in <<uml_quantity_class>> and <<uml_quantityrange_class>>,  and the “UomTime” UML class used in <<uml_time_class>> and <<uml_timerange_class>>, as defining the model for “UnitOfMeasure” and “UomTime” are out of scope for SWE Common.
