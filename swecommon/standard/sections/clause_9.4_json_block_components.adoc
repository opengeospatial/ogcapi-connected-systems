...
When provided inline, “DataArray” values are encoded using the method defined in <<json_value_block>>.
...
When provided inline, “Matrix” values are encoded using the method defined in <<json_value_block>>.
...
When provided inline, “DataStream” values are encoded using the method defined in <<json_value_block>>.
