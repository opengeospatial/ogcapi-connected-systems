...
The “BinaryEncoding” object is the JSON schema implementation of the “BinaryEncoding” UML class defined in <<uml_binaryencoding_class>>. The schema for this class is provided in {jsonschema-base-url}/encodings.json[encodings.json#/definitions/BinaryEncoding].
