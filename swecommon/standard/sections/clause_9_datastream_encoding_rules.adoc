...
include::clause_9.2_text_encoding_rules.adoc[]

include::clause_9.3_xml_encoding_rules.adoc[]

include::clause_9.4_binary_encoding_rules.adoc[]

include::clause_9.5_json_encoding_rules.adoc[]