...
#Special Numerical Values: NaN, Inifinity, -Infinity#

#Date & Time Values: ISO8601 encoding#

#Links: Some linking disallowed in the JSON encoding. Use xlink or web linking syntax?#
